...
public class RolController implements Serializable {
    ...
    public void create() {
        ...
        context.execute("PF('RolCreateDialog').hide();");
    }
    ...
    public void destroy(Rol rol) {
        ...
        if (!selected.getUsuarios().isEmpty()) {
            JsfUtil.addErrorMessage("No se puede eliminar debido a que hay usuarios que dependen de este rol");
        } else {
        ...
        if (selected != null) {
            ...
            try {
                if (persistAction != PersistAction.DELETE) {
                    System.out.println("_____:   "+ getFacade());
