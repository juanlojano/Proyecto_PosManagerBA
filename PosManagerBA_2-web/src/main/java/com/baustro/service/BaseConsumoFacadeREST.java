...
public class BaseConsumoFacadeREST extends AbstractFacade<BaseConsumo> {
...
//    public void create(BaseConsumo entity) {
//        super.create(entity);
//    }
    ...
    @Path("crear")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public Response postCrearBaseConsumo(BaseConsumo entity) {        
        try{
            super.create(entity);
...
//    @Path("{id}")
//    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
//    public void edit(@PathParam("id") Long id, BaseConsumo entity) {
//        super.edit(entity);
//    }
//
//    @DELETE
...
//    public BaseConsumo find(@PathParam("id") Long id) {
...
//    @Override
//    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
//    public List<BaseConsumo> findAll() {
...
//    @Path("{from}/{to}")
//    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
//    public List<BaseConsumo> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
